...
from agent.graph.workflow import ALL_TOOLS
...
async def connect_and_relay(
    session_id: str, token: str, backend_url: str = "ws://localhost:8000"
):
            ...
            try:
                ...
                if data.get("type") == "rpc_call":
                    ...
                    try:
                        ...
                        print(
                            f"[RPC RESULT] Successfully executed and returned result for {tool_name}"
                        )
